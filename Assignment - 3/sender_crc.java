...
class sender_crc
{
    ...
    {
        try{
            DatagramSocket ds1 = new DatagramSocket(); Scanner sc = new Scanner(System.in); System.out.print("Enter Data: ");
            String data = sc.nextLine(); String key = "11";
            String rem = div(data,key); System.out.println("rem = "+rem); String sendmsg = data + rem;
            System.out.println("send_msg = "+sendmsg); InetAddress ip = InetAddress.getByName("localhost");
